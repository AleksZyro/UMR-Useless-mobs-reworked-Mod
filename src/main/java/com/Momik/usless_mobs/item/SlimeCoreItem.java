...
public class SlimeCoreItem extends Item {
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand usedHand) {
        ...
        SlimePowerToggle.applyFiltered(player, com.Momik.usless_mobs.registry.ModEffects.ELASTICITY.get(), 220, verticalJump ? 1 : 0);
        SlimePowerToggle.applyFiltered(player, MobEffects.JUMP, 180, 1);
        SlimePowerToggle.applyFiltered(player, MobEffects.SLOW_FALLING, 120, 0);
        SlimePowerToggle.applyFiltered(player, MobEffects.MOVEMENT_SPEED, 120, 0);
        ...
        serverLevel.sendParticles(new ItemParticleOption(ParticleTypes.ITEM, new ItemStack(com.Momik.usless_mobs.registry.ModItems.BLAUER_SCHLEIMBALL.get())),
