...
ROWS = [
    ...
    ("Living Polar Bear", "EINGEBUNDEN", "Eigenes Entity-, Spawn-Ei-, Renderer-, Mesh- und Texturpaket ist vorhanden.", "Das vermeintliche schwebende Gesicht gehörte zum benachbarten Oktopus. Die Galerie blendet Nachbarmobs nun aus; Eisbär-Mesh nicht unnötig beschädigen."),
